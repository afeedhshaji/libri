    ...
    <div class="flex flex-col h-screen justify-between">
        ...
        <div class="container w-full mx-auto pt-20 lg:pt-40">
            ...
            <div class="w-full px-4 md:px-0 mb-16 text-gray-800 leading-normal">
                ...
                <?php
                    $sql = "select LMS.book.BookId, LMS.author.Author, LMS.book.Availability, LMS.book.Title, LMS.book.Publisher,
                            LMS.book.Year from LMS.book LEFT JOIN LMS.author on LMS.book.BookId=LMS.author.BookId order by Availability
                            DESC";
                    $result = $conn->query($sql);
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <td
                                ...
                                <a href="edit_book_details.php?id=<?php echo $bookid; ?>" class="text-blue-400 mx-auto
                                    hover:text-blue-600 underline">Edit</a>

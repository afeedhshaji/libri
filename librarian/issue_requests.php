...
<head>
    ...
    <title>Admin - Issue Requests</title>
</head>
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <td
                                class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                                <span
                                    class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Availability</span>
                                <?php echo $avail ?>
                            </td>
                            <td
                                class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                                <span
                                    ...
                                    Actions</span>
                                <?php if ($avail > 0) {
                                                echo "<a href=\"accept_issue.php?id1=" . $bookid . "&id2=" . $rollno . "\" class=\"text-blue-400 mx-auto hover:text-blue-600 underline\">Accept</a>";
                                            } ?>
                                <a href="reject_issue.php?id1=<?php echo $bookid ?>&id2=<?php echo $rollno ?>" class="text-blue-400 mx-auto
